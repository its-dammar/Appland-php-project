            ...
            <div class="card-body">
                  ...
                  if ($filesize <= 300000) {
                    if ($ext == 'jpg' || $ext == 'png' || $ext == 'jpeg') {
                      if (move_uploaded_file($_FILES['dataFile']['tmp_name'], '../uploads/' . $finalname)) {
                        $query = "INSERT INTO app_feature(top_title,description, img) VALUES('$title','$description', '$finalname')";
              ...
              <form class="row g-3" method="POST" enctype="multipart/form-data">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="top_title">
                </div>
                <div class="col-md-6">

          ...
          <div class="card">
            <div class="card-body">
              ...
              if (isset($_POST['save'])) {
                ...
                if ($site_value != "" && $site_key != "" ) {
                  $submit = "INSERT INTO settings (site_key, site_value) 
              ...
              <form class="row g-3" method="POST" enctype="multipart/form-data">
                <div class="col-md-6">
                  <label for="inputName5" class="form-label">Site Key Name</label>
                  <input type="text" class="form-control" id="inputName5" name="site_key">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail5" class="form-label">Site Value</label>
                  <input type="text" class="form-control" id="inputEmail5" name="site_value">
                </div>
                <div class="col-md-12">
